        ...
        <div>
          ...
          <div className="space-y-2">
            {score.requirementResults.map((req) => (
              <div key={req.id} className="py-2 border-b border-line last:border-0">
                <div className="flex items-center gap-2 mb-1">
                  {req.passed ? (
                    <IconCheck className="w-4 h-4 text-leaf" />
                  ) : (
        ...
        <div>
          ...
          <div className="space-y-2">
            {score.scoreBreakdown.map((sig) => (
              <div key={sig.id} className="py-2 border-b border-line last:border-0">
